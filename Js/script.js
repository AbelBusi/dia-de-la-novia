...
function showSignature() {
  ...
  signature.textContent = firma ? decodeURIComponent(firma) : "Con amor, Abel :)";
...
function showCountdown() {
  ...
  let startDate = startParam ? new Date(startParam + 'T00:00:00') : new Date('2024-06-13T00:00:00'); // Inicio real
  let eventDate = eventParam ? new Date(eventParam + 'T00:00:00') : new Date('2025-08-01T00:00:00'); // Día de la novia
  ...
  function update() {
    ...
    container.innerHTML = `
       Desde que empezamos el <strong>13 de junio de 2024</strong>,<br>
      llevamos <b>${days}</b> días juntos.<br>
      Seguimos siendo flacos, pero cada vez más unidos.<br><br>
      🥰 Falta para el Día de la Novia:<br>
      <b>${eventDays}d ${eventHours}h ${eventMinutes}m ${eventSeconds}s</b><br><br>
      Gracias por quererme con limón, sal... y con besitos jajsaja incluido.
    `;
